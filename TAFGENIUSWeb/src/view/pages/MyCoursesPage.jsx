...
import { useCourseViewModel } from "../../viewmodel/course_viewmodel";

export default function MyCoursesPage() {
  const navigate = useNavigate();
  const {
    search, setSearch,
    filteredMyCourses, filteredRecommended
  } = useCourseViewModel();
  ...
  return (
    <div style={{ padding: "30px", marginLeft: "240px", maxWidth: "900px", marginRight: "auto", marginTop: "50px" }}>
      <div style={{ position: "relative", marginBottom: "30px" }}>
        <BiSearch
          style={{ position: "absolute", top: "50%", left: "12px", transform: "translateY(-50%)", color: "#888", fontSize: "20px" }}
        />
        <input
          type="text"
          ...
          style={{ width: "100%", padding: "10px 15px 10px 40px", borderRadius: "8px", border: "1px solid #ccc", fontSize: "16px" }}
        />
      </div>
